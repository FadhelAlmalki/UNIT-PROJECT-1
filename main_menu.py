...
def main_menu():
    print(text2art("TerminalSensei", font="slant"))
    print(Fore.CYAN + "An Interactive Japanese Learning CLI Application".center(80) + Fore.RESET)
    print(Fore.CYAN +"日本語学習CLIアプリケーション".center(65) + Fore.RESET)
    while True:
        ...
        choice = input(f"\n{Fore.YELLOW}Select an option (1-8): {Fore.RESET}")
